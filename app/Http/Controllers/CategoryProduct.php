...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home(Request $request ,$slug_category_product){
       //slide
        ...
        $current_category = DB::table('tbl_category_product')
            ->where('slug_category_product', $slug_category_product)
            ->first();
        if ($current_category) {
            $meta_desc = $current_category->category_desc;
            $meta_keywords = $current_category->meta_keywords;
            $meta_title = $current_category->category_name;
            ...
            return view('pages.category.show_category', [
                ...
                'slider' => $slider,
                'current_category' => $current_category // thay cho $category_name
            ]);
    }
