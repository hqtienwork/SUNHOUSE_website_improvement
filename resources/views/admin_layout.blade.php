...
<!--logo start-->
<div class="brand text-center" style="padding: 10px 0;">
    <a href="{{ url('/') }}">
        <img src="{{ asset('public/frontend/images/logoSH.png') }}" alt="Logo" style="width: 50%; height: auto;" />
    </a>
</div>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Demo Copyright by Ho Quang Tien</p>
			</div>
		  </div>
  <!-- / footer -->
</section>
