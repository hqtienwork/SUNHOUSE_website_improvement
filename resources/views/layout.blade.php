...
<head>
    ...
    {{--   <meta property="og:image" content="{{$image_og}}" />  
      <meta property="og:site_name" content="SH_Test_Laravel" />
...
<body>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            ...
                            <li><a><i class="fa fa-phone" style="margin-right: 8px;"></i>024.37366676 / 024.37366686</a></li>
                            <li><a><i class="fa fa-envelope" style="margin-right: 8px;"></i>info@sunhouse.com.vn</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <a href="{{ url('/') }}"><img src="{{ asset('public/frontend/images/logoSH.png') }}" alt="" style="width: 45%; height: auto;" /></a>
                        </div>
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box pull-right">
                            <input type="text" style="margin:0; name="keywords_submit" placeholder="Tìm kiếm sản phẩm"/>
                            <input type="submit" style="margin:0; color:#ffffff" name="search_items" class="btn btn-primary btn-sm" value="Tìm kiếm">
                        </div>
                        </form>
                    </div>
                </div>
    ...
    <footer id="footer"><!--Footer-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Thành tích giải thưởng</a></li>
                                <li><a href="#">SUNHOUSE TV</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Tin thưởng thức</a></li>
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Xác thực sản phẩm</a></li>
                    ...
                    <div class="col-sm-3 col-sm-offset-1">
                        <div class="single-widget">
                            <h2>Đăng ký tin tức</h2>
                            <form action="#" class="searchform">
                                <input type="text" placeholder="Điền email của bạn..." />
                                <button type="submit" class="btn btn-default"><i class="fa fa-arrow-circle-o-right"></i></button>
                                <p>Cập nhật những thông tin mới nhất <br/>về các dịch vụ của SUNHOUSE</p>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2025 SUNHOUSE.com.vn [Demo Website Thương mại điện tử]</p>
                    <p class="pull-right">Designed by Ho Quang Tien</p>
                </div>
            </div>
        </div>
